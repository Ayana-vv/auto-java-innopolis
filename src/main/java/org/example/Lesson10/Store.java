...
public class Store {
    public static void main(String[] args) {
        ...
        //вывод товаров отсортированными по цене / рейтингу / названию / убыванию цены
        ...
        Comparator<Item> comparatorName = new Comparator<Item>() {
            @Override
            public int compare(Item o1, Item o2) {
                return o1.getName().compareTo(o2.getName());
            }
        };
        Comparator<Item> comparatorPriceDown = new Comparator<Item>() {
            @Override
            public int compare(Item o1, Item o2) {
        ...
        items.sort(comparatorName);
        System.out.println(items);

        items.sort(comparatorPriceDown);
        System.out.println(items);
    }
}
